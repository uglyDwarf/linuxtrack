...
{
      10,     0,    -1,    -1,    10,    11,    -1,    10,     3,    -1,
      10,    12,    -1,     4,     6,     5,    -1,     6,     7,     8,
      -1
};
...
static const char *const yytname[] =
{
  ...
  "TOKEN_RIGHT_BRACKET", "TOKEN_KEY", "TOKEN_EQ", "TOKEN_VALUE", "$accept",
  "input", "section", "key_val_pair", 0
};
#endif
